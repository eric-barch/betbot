...
exports.oldOddsSequelizeInstance = exports.oldOddsSequelizeModel = void 0;
const sequelize = __importStar(require("sequelize"));
const instance_1 = require("../instance");
exports.oldOddsSequelizeModel = instance_1.sequelizeInstance.define('OldOdds', {
    id: {
...
class oldOddsSequelizeInstance {
    constructor({ odds, }) {
        this.odds = odds;
    ...
    initialize() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.sequelizeInstance = yield exports.oldOddsSequelizeModel.findOrCreate({
                where: {
...
exports.oldOddsSequelizeInstance = oldOddsSequelizeInstance;
//# sourceMappingURL=oldOddsSequelize.js.map