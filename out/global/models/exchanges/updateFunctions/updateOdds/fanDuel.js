...
const fanDuel_1 = require("../updateOddElements/fanDuel");
async function spreadAway({ exchange, statistic, }) {
    const updateOverOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`spread_away_over`);
    ...
    const updateUnderOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`spread_away_under`);
...
async function spreadHome({ exchange, statistic, }) {
    const updateOverOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`spread_home_over`);
    if (!updateOverOddElementsFunction) {
        throw new Error(`Did not find function`);
    }
    const overOddExists = await updateOverOddElementsFunction({
    ...
    const updateUnderOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`spread_home_under`);
    if (!updateUnderOddElementsFunction) {
        throw new Error(`Did not find function`);
    }
    const underOddExists = await updateUnderOddElementsFunction({
...
async function moneyline({ exchange, statistic, }) {
    const updateAwayOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`moneyline_away`);
    ...
    const updateHomeOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`moneyline_home`);
...
async function total({ exchange, statistic, }) {
    const updateOverOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`total_over`);
    if (!updateOverOddElementsFunction) {
        throw new Error(`Did not find function`);
    }
    const overOddExists = await updateOverOddElementsFunction({
    ...
    const updateUnderOddElementsFunction = fanDuel_1.updateOddElementsFunctions.get(`total_under`);
    if (!updateUnderOddElementsFunction) {
        throw new Error(`Did not find function`);
    }
    const underOddExists = await updateUnderOddElementsFunction({
