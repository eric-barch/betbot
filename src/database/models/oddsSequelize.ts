...
export const OddsSequelizeModel = sequelizeInstance.define('Odds', {
    id: {
...
export class OddsSequelizeInstance {
    ...
    public async initialize() {
        this.sequelizeInstance = await OddsSequelizeModel.findOrCreate({
            where: {
