...
export async function fanDuel(this: classes.exchanges.exchangePageUtilities.utilityImplementations.ExchangePageParser, {
    verbose = false,
}: {
    verbose?: boolean,
} = {}) {
    ...
    let exchangeGames = new Array<classes.games.Game>;
