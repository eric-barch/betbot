...
export const OddsOldSequelizeModel = sequelizeInstance.define('OddsOld', {
    id: {
...
export class OddsOldSequelizeInstance {
    ...
    public async initialize() {
        this.sequelizeInstance = await OddsOldSequelizeModel.findOrCreate({
            where: {
