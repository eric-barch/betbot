...
export class DocumentGamesParser {
  ...
  public async getGames(): Promise<Array<db.models.Game>> {
    ...
    const thElements = await this.gamesPageParser.page.$$(
  ...
  private async getTeam({ thElement }: { thElement: p.ElementHandle }): Promise<db.models.Team> {
  ...
  private async getMatchupString({ thElement }: { thElement: p.ElementHandle }): Promise<string> {
  ...
  private async getStartDate({ thElement }: { thElement: p.ElementHandle }) {
  ...
  private async getDateString({ thElement }: { thElement: p.ElementHandle }) {
  ...
  private async getTimeString({ thElement }: { thElement: p.ElementHandle }): Promise<string> {
