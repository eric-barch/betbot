...
function initiate() {
    return __awaiter(this, void 0, void 0, function* () {
        // const verbose = verbosity.database.sequelize.initiate;
        try {
            yield database.sequelize.instance.instance.authenticate();
        ...
        yield database.sequelize.instance.instance.sync({
            alter: true,
            logging: false,
        });
    });
